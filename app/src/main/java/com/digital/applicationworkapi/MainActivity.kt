package com.digital.applicationworkapi
...
import com.digital.applicationworkapi.api.MyRetrofit
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getData() {
        val call = MyRetrofit.instance?.productApi()?.getProductApi() as Call<List<Product>>
